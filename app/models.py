...
class Process(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('Processes/list')

    def __str__(self):
        return self.name

class ItemRoles(models.Model):
    name = models.CharField(max_length = 255, unique = True)
...
class ProjectParameter(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('Project_Parameters/list')
...
class ParameterValue(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('Parameter_Values/list')
...
class ProjectRequirement(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('Project_Requirements/list')
...
class ProjectRequirementCondition(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('Project_Requirement_Conditions/list')
